...
Uses the same database URL and metadata as the runtime app, so autogenerate
sees every table declared on ``lpb_core.db.Base``.
"""
...
from lpb_core.db import Base  # registers all models on Base.metadata
